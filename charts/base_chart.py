...
class BaseChart:
    ...
    def _generate_detail_selector_html(self) -> str:
        """
        Генерирует HTML переключателя детализации
        ...
        <div class="detail-selector">
            <button class="detail-btn" data-level="year" onclick="setDetailLevel_{self.chart_id}('year')">Год</button>
            <button class="detail-btn active" data-level="month" onclick="setDetailLevel_{self.chart_id}('month')">Месяц</button>
            <button class="detail-btn" data-level="week" onclick="setDetailLevel_{self.chart_id}('week')">Неделя</button>
            <button class="detail-btn" data-level="day" onclick="setDetailLevel_{self.chart_id}('day')">День</button>
        </div>
        '''
    ...
    def _generate_detail_level_js(self) -> str:
        """
        Генерирует JS функцию для переключения детализации

        Returns:
            JS код функции setDetailLevel_{chart_id}
        """
        return f'''
        function setDetailLevel_{self.chart_id}(level) {{
            setDetailLevel('{self.chart_id}', level);
        }}
        '''
